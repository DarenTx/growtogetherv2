---
name: tailwind-v4
description: Tailwind CSS v4 with CSS-first configuration and design tokens. Use when defining theme variables, using OKLCH colors, or configuring dark mode. Triggers on @theme, oklch, CSS variables, --color-, tailwind v4.
---
