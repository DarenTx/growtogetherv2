...
\restrict nPvGOYdGviAyvG1r16ClPE53ixh4jgJmPGyuVbj4DKTjTjYyY2SRhfWofuS5s8h
...
CREATE TRIGGER on_auth_user_updated AFTER UPDATE ON auth.users FOR EACH ROW EXECUTE FUNCTION public.sync_verification_status();
...
--
-- Name: FUNCTION get_audit_log_page(p_offset integer, p_limit integer); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.get_audit_log_page(p_offset integer, p_limit integer) TO anon;
GRANT ALL ON FUNCTION public.get_audit_log_page(p_offset integer, p_limit integer) TO authenticated;
GRANT ALL ON FUNCTION public.get_audit_log_page(p_offset integer, p_limit integer) TO service_role;
...
--
-- Name: FUNCTION is_registered(); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.is_registered() TO anon;
GRANT ALL ON FUNCTION public.is_registered() TO authenticated;
GRANT ALL ON FUNCTION public.is_registered() TO service_role;


--
-- Name: FUNCTION process_audit_log(); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION sync_verification_status(); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.sync_verification_status() TO anon;
GRANT ALL ON FUNCTION public.sync_verification_status() TO authenticated;
GRANT ALL ON FUNCTION public.sync_verification_status() TO service_role;
...
--
-- Name: TABLE growth_data; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.growth_data TO anon;
GRANT ALL ON TABLE public.growth_data TO authenticated;
GRANT ALL ON TABLE public.growth_data TO service_role;


--
-- Name: TABLE market_indexes; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: VIEW person_bank_list; Type: ACL; Schema: public; Owner: postgres
--

GRANT SELECT ON TABLE public.person_bank_list TO authenticated;
GRANT SELECT ON TABLE public.person_bank_list TO service_role;
...
\unrestrict nPvGOYdGviAyvG1r16ClPE53ixh4jgJmPGyuVbj4DKTjTjYyY2SRhfWofuS5s8h
